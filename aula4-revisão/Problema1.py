...
gasto_cliente =calcular_gasto_cliente(pedidos,nome_cliente)
print(f'O gasto do cliente foi:{gasto_cliente:.2f} reais')
pratoMais= prato_mais_vendido(pedidos)
print(f'O prato mais vendido foi: {pratoMais}')
